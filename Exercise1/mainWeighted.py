...
def compare_soft_and_regular_and_weighted_decision_tree(x, y, criterion='gini', max_depth=None, min_samples_leaf=1,
                                           min_samples_split=2, max_features=None,
                                           alpha=0.1, n_samples=100, random_state=None):
    """
    Compare performance of regular DecisionTreeClassifier, SoftDecisionTreeClassifier, 
    and WeightedDecisionTreeClassifier. 
    Includes accuracy scores, pruning, and ROC curves.
    """
    x = pd.DataFrame(x)
    y = pd.Series(y)
    ...
    clf_weighted = WeightedDecisionTreeClassifier(alpha=alpha, n_samples=n_samples, criterion=criterion,
                                                  random_state=random_state,
                                                  max_depth=max_depth, min_samples_leaf=min_samples_leaf,
                                                  min_samples_split=min_samples_split, max_features=max_features)


    cld_softdistance = SoftDistanceDecisionTreeClassifier(alpha=alpha, n_samples=n_samples, criterion=criterion,
                                                  random_state=random_state,
                                                  max_depth=max_depth, min_samples_leaf=min_samples_leaf,
                                                  min_samples_split=min_samples_split, max_features=max_features)
    ...
    print('\nSoftDistanceDecisionTreeClassifier:')
    evaluate_classifier(cld_softdistance, x, y)
...
if __name__ == '__main__':
    ...
    data = pd.read_csv(
        r'C:\Users\Noa\Documents\Studies\ML_exercises\Exercise1\datasets\classification\mobile_price.csv')
    ...
    compare_soft_and_regular_and_weighted_decision_tree(X, Y, max_depth=10, max_features='sqrt', min_samples_leaf=1,
                                           min_samples_split=10, alpha=0.1, n_samples=50)
    print("\n")

    # # 35 features, 2149 samples
    # data = pd.read_csv(
    #     r'C:\Users\Noa\Documents\Studies\ML_exercises\Exercise1\datasets\classification\alzheimers_disease_data.csv')
    # X, Y = data.drop(columns=['Diagnosis', 'DoctorInCharge']), data['Diagnosis']

    # print("alzheimers_disease Dataset\n")
    # print_best_decision_tree_classifier(X, Y)
    # find_best_hyperparameters_for_soft_classifier(X, Y)
    # compare_soft_and_regular_and_weighted_decision_tree(X, Y, criterion='entropy', max_depth=10, max_features='sqrt',
    #                                        min_samples_leaf=1,
    ...
    # data = pd.read_csv(
    #     r'C:\Users\Noa\Documents\Studies\ML_exercises\Exercise1\datasets\classification\Student_performance_data _.csv')
    # X, Y = data.drop(columns=['GradeClass']), data['GradeClass']

    # print("Student Performance Dataset\n")
    # print_best_decision_tree_classifier(X, Y)
    # find_best_hyperparameters_for_soft_classifier(X, Y)
    # compare_soft_and_regular_and_weighted_decision_tree(X, Y, max_depth=20, max_features='log2', min_samples_leaf=1,
    #                                        min_samples_split=20, alpha=0.03, n_samples=500)
    # print("\n")

    # # 13 features, 52444 samples
    # data = pd.read_csv(
    #     r'C:\Users\Noa\Documents\Studies\ML_exercises\Exercise1\datasets\classification\mountains_vs_beaches_preferences.csv')
    ...
    # print_best_decision_tree_classifier(X, Y)
    # find_best_hyperparameters_for_soft_classifier(X, Y)
    # compare_soft_and_regular_and_weighted_decision_tree(X, Y, criterion='entropy', max_depth=20, max_features='sqrt',
    #                                        min_samples_leaf=1,
    ...
    # data = pd.read_csv(
    #     r'C:\Users\Noa\Documents\Studies\ML_exercises\Exercise1\datasets\classification\Airline.csv')
    ...
    # print_best_decision_tree_classifier(X, Y)
    # find_best_hyperparameters_for_soft_classifier(X, Y)
    # compare_soft_and_regular_and_weighted_decision_tree(X, Y, criterion='entropy', max_depth=20, max_features='log2',
    #                                        min_samples_leaf=1,
